class Api {
  /// Release
  /// Demo
  static const baseURL = "https://www.ciptapro.com/pos-kelontong-busumi";
  /// Local network
  ...
  /// Sales Saved Edit & Delete
  static const updateItemSaved = "${baseURL+api}sales/saved/update";
  static const deleteSalesSaved = "${baseURL+api}sales/delete";
  static const deleteItemSalesSaved = "${baseURL+api}sales/delete-item";
