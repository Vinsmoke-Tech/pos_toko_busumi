...
class _SalesDetailPageState extends State<SalesDetailPage> {
  ...
  Future<void> deleteCartItemsJson(int index) async {
    setState(() {
      double totalPrice = 0;
      num quantity = 0;
  ...
  Widget makeCard(context, int index) {
    return CustomListTile(
        ...
        showDialog(
            ...
            builder: (context) {
              return AlertDialog(
                ...
                content: const Text(
                  'Apakah anda yakin ingin menghapus item pesanan?',
                  style: TextStyle(
                      color: Colors.black,
                      fontSize: 14
                  ),
      ...
      topSubtitleText: CurrencyFormat.convertToIdr(int.parse(cartItemsJson[index]['item_unit_price']), 0),
      bottomTitleText: descriptionMap['description_${cartItemsJson[index]['item_id']}'] != null ? "Catatan :\n${descriptionMap['description_${cartItemsJson[index]['item_id']}']}" : "Catatan :\n" " ",
    );
  }
        ...
        children: [
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Text(
                descriptionMap['description_${cartItemsJson[index]['item_id']}'] != null
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        setState(() {
          ...
          total = subtotal + (subtotal * ppnPercentageTotal / 100);
